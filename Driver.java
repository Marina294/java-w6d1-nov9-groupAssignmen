...
public class Driver {
	...
	public static void main(String[] args) {
		...
		Patient patient1 = new Patient("male");
		Patient patient2 = new Patient("female");
		Patient patient3 = new Patient("male");
		Patient patient4 = new Patient("female");
		Patient patient5 = new Patient("male");
		Patient patient6 = new Patient("female");
		Patient patient7 = new Patient("male");
		Patient patient8 = new Patient("female");
		Patient patient9 = new Patient("male");
		Patient patient10 = new Patient("female");
